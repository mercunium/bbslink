...
Okay I use a very customized version of GameSrv for my BBS but this *should* work for any BBS that can run DOOR32 stuff,
generate a DOOR32.SYS file and can run .NET 2.0 stuff.
